...
public class ExceptionHandling implements ErrorController {
    ...
    private static final String INCORRECT_CREDENTIALS = "Username and / or password incorrect. Please try again";
    ...
    public ResponseEntity<HttpResponse> emailExistException(EmailExistsException e) {
